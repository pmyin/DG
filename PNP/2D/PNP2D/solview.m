...
while 1 % & (Fig==target)
    FileName=strcat('u', int2str(Fig), '.txt');
    xFileName=strcat('x', int2str(Fig), '.txt');

    fp=fopen(FileName);
    if (fp<0 & strcmp(FileNamestop, ''))
        FileNamestop='uR.txt';
        xFileNamestop='xR.txt';
    elseif (fp<0 & strcmp(FileNamestop, 'uR.txt'))
        break;
    end
    if (fp>=0)
    fclose(fp);
    ...
    if (strcmp(FileNamestop, 'uR.txt'))
        FileName = FileNamestop;
        xFileName = xFileNamestop;
    end
